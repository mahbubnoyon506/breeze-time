          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mt-8">
              <input
                ...
                className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-md font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full cursor-pointer"
                value={'Login'}
              />
            </div>
          </form>
