            ...
            <div className="w-11/12 grid grid-cols lg:grid-cols-2 gap-0 lg:gap-12 mx-auto justify-center items-center">
                ...
                <div className="shadow-2xl rounded-xl w-4/5 p-10 mt-16" data-aos="fade-left">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="mt-8">
                            <input type={'submit'} aria-label="create my account" className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-md font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full cursor-pointer" value={'Signin'} />
                        </div>
                    </form>
                    ...
                    <div className='grid grid-cols-3 gap-2'>
                        <button onClick={handleGoogleSignIn} aria-label="Continue with google" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-2 border rounded-lg border-gray-700 flex items-center mt-4">
                            <svg width={19} height={20} viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg" className='mx-1'>
                        ...
                        <button disabled aria-label="Continue with github" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-2 border rounded-lg border-gray-700 flex items-center mt-4">
                            <svg width={21} height={20} viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg" className='mx-1'>
                                <path
                        ...
                        <button disabled aria-label="Continue with twitter" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-2 border rounded-lg border-gray-700 flex items-center mt-4">
