...
const Navbar = () => {
  ...
  useEffect(() => {
    fetch('https://breeze-time-server.vercel.app/notifications')
      .then((res) => res.json())
  ...
  const dashboardMenu = (
    <>
      ...
      <div className="dropdown dropdown-end dropdown-hover">
        ...
        <ul
          tabindex="0"
          className="dropdown-content menu py-5 p-2 shadow bg-base-100 rounded-box w-52"
        >
          ...
          <label
            for="dashboard-drawyer"
            className="py-3 pl-5 lg:hidden cursor-pointer"
          >
            Dashboard Menu
          </label>
