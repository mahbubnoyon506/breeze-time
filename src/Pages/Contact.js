        ...
        <div className="flex flex-col lg:flex-row lg:items-center text-slate-900 lg:justify-between -mx-4">
          ...
          >
            <div className="max-w-[570px] mb-12 lg:mb-0">
              ...
              <p className="lg:py-6 sm:py-3 ">
                Submit your inquiry for your Enterprise — ideal for companies
                with more than 100 employees — and one of our scheduling experts
                will reach out if there is a fit.
              </p>
            </div>
          </div>
          <div
            ...
            <div className="bg-gray-100 dark:bg-slate-800 relative rounded-lg p-8 sm:p-12 shadow-lg">
              <form onSubmit={sendEmail}>
                ...
                <div>
                  <button
                    type="submit"
                    className="btn btn-primary hover:bg-accent hover:text-primary"
                  >
                    Submit
                  </button>
                </div>
