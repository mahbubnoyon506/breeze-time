...
const Banner = () => {
  ...
  <div class="flex-shrink-0 w-full max-w-lg shadow-2xl bg-base-100">
    ...
    <div class="text-center text-lg px-5 lg:text-left ">
      ...
      <Link to=''><button className='btn bg-orange-600 border-none text-white rounded-lg hover:bg-orange-500 '>Let's Go</button></Link>
    </div>
