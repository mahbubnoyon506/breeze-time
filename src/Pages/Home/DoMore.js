      ...
      <div className="bg-white">
        <div className="lg:flex justify-between items-center mx-10 flex-row-reverse py-10">
          ...
          <div className="lg:pr-40 text-center" data-aos="fade-right">
            ...
            <p className="pt-5">
              BreezeTime puts your entire meeting workflow on autopilot, sending
              everything from reminder emails to thank you notes, so you can
              focus on the work only you can do. It's like getting an assistant,
              even if you're a business of one.
            </p>
          </div>
        </div>
        ...
        <div className="lg:flex justify-between items-center mx-10 flex-row-reverse py-10">
          ...
          <div className="lg:pr-40 text-center" data-aos="fade-right">
            ...
            <p className="pt-5">
              Time is a precious commodity. BreezeTime is the courteous way to
              book meetings and other appointments, because scheduling with just
              a few clicks makes the most of everyone's time.
            </p>
          </div>
        </div>
      </div>
