    ...
    return (
        <>
            <div className='bg-white '>
                ...
                <div className='lg:flex justify-between items-center mx-16 flex-row-reverse py-10'>
                    <div className='w-4/6 sm:mx-auto' data-aos="zoom-in">
                        <img className=" mx-auto" src={doMore1} alt="Do More" />
                    </div>
                    <div className='lg:pr-40 text-center px-10' data-aos="zoom-in">
