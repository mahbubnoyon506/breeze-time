    ...
    <div className="lg:mx-16 md:mx-8 sm:mx-3 ">
      ...
      <div className="cards ">
        <div className="card grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-4 ">
          {' '}
          <div className="card w-96 bg-base-200 mx-auto hover:rounded-lg hover:bg-sky-400 ">
            <div className="card-body">
              ...
              <Link to="" className="m-auto">
                <button className=" my-3 btn bg-transparent border-black text-black rounded-lg hover:bg-orange-500 hover:border-orange-500 hover:text-white">
                  Get started
                </button>
              </Link>
