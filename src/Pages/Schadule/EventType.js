        ...
        <div className='flex justify-center items-center'>
            <div className='flex flex-col justify-center container'>
                <div className='flex justify-center items-center my-6'>
                    <div className=' w-1/2'>
                        <button className="btn btn-ghost outline outline-primary text-primary">Back</button>
                    </div>
                    <p className='w-1/2 text-xl'>Create New Event Type</p>
                </div>
                <div className="bg-white mb-12 mt-6 rounded">
                    {/* one-on-one meeting  */}
                    <div className="flex flex-wrap sm:flex-no-wrap items-center justify-center w-full h-32  mt-8">
                        ...
                        <div className="flex justify-end items-center w-full sm:w-1/3 rounded-b sm:rounded-b-none" >
                            <button className="btn btn-primary rounded-full">Create</button>
                        </div>
                    </div>
                    {/* group meeting  */}
